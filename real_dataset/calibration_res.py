...
checkpoint_path = 'checkpoints/maeloss_weights/encoded_dim_2/na-epoch=43-val_loss=0.00770.ckpt'
...
for batch_idx, batch in enumerate(test_loader):
    ...
    voxel_observations = smax2(voxel_observations)
    ...
    out = model(encodeinput, valid_mask, size0=voxel_observations.size(0), size1=voxel_observations.size(1))
    # out_normal = ground_truth
