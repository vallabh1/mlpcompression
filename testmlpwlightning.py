...
wandb.init(project="second_training_artificial_dataset_mseloss")
...
# train model
trainer = L.Trainer(default_root_dir='./checkpoints', max_epochs=75, logger=wandb_logger, callbacks=[EarlyStopping(monitor="val_loss", mode="min")])
