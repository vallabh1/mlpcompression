...
checkpoint_path8 = 'checkpoints/encoded_dim_10-cumsum_mseloss-na-epoch=453-val_loss=0.00030.ckpt'
...
model8 = LitAutoEncoder.load_from_checkpoint(checkpoint_path8, encoder=Encoder(num_classes, 10), decoder=Decoder(10, num_classes))
...
for i in range(5):
    ...
    out8 = model8(encodeinput, num_obs=num_obs, encoded_dim=10)
